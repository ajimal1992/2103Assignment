                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($cursor as $document) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="UpdateInfantsData.php?year=<?php echo $document["birth_year"]; ?>&_id=<?php echo $document["_id"]; ?>">Edit</a></td> 
                                                            <!-- delete -->
                                                            <td><a href="delete2.php?infantID=<?php echo $document['_id']; ?>&total=<?php echo $document['value'] ?>&infantyear=<?php echo $document['birth_year'] ?>"onclick="return deletechecked();">Delete</a></td>
                                            ...
                                            foreach ($cursor_mortality as $document_mortality) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="UpdateMortalityData.php?birth_year=<?php echo $document_mortality['birth_year']; ?> 
                                                           &ethnicity=<?php echo $document_mortality['ethnicity'] ?>&_id=<?php echo $document_mortality["_id"]; ?>">Edit</a></td> 
                                                    <!--DELETE HERE -->
                        ...
                        <div class="col-lg-12">
                            <div class="scroll">
                                <h2>
                                    Father
                                    <div>
                                        <a href="addFathersData.php" class="btn btn-primary">Add New Fathers Record</a>
                                    </div>
                                </h2>
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover">
