...
if (isset($_POST['approve']) && isset($_POST['select']) && $userType == "Admin") {
    foreach ($_POST['select'] as $check) {
        ...
        $approveCollection->insert(array("updateID"=>(string)$updateID, "admin_userID"=> $userID, "assist_userID"=> $AssistUserID,"timestamp"=> new MongoDate()));
