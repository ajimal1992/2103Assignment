...
if($user['accountType'] == 'Admin'){
    ...
    $sql = "UPDATE Mother_births_by
        SET birth_year = ?, mth = ?, child_gender = ?, race = ?, age_group = ?, live_births = ?   
        WHERE inforID = ?";

    $result = sqlsrv_query($conn, $sql, array($birth_year, $mth, $child_gender, $race, $age_group, $live_births, $inforID));
