...
//               alert(data);
               ...
               for (var i = 0, len = data.length; i < len; i++){
                   $("#filterBy").append('<option value=' + data[i]+ '>' + data[i] + '</option>')   //Due to the way its return in nosql, instead of data[i][0], u put data[i]
               }
           }, 
...
//          alert(data);
          ...
          $('#minYear').empty();
          for (var i = 0, len = data.length; i < len; i++){
              $("#maxYear").append('<option value=' + data[i] + '>' + data[i] + '</option>')
              $("#minYear").append('<option value=' + data[i] + '>' + data[i] + '</option>')
          }
      } 
    });
}
